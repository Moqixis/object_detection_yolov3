...
# 创建创建一个存储检测结果的dir
result_path = 'mycode/test2/result/'
...
class YOLO(object):
    _defaults = {
        "model_path": 'mycode/test2/logs/trained_weights_final.h5',
        "anchors_path": 'mycode/test2/model_data/tiny_yolo_anchors.txt',
        "classes_path": 'mycode/test2/model_data/voc_classes.txt',
        "score" : 0.3,
        "iou" : 0.45,
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='mycode/test2/font/FiraMono-Medium.otf',
...
if __name__ == '__main__':
    # 读取test文件
    with open("mycode/test2/VOCdevkit/VOC2007/ImageSets/Main/test.txt", 'r') as f:  # 打开文件
    ...
    for filename in test_list:
        image_path = 'mycode/test2/VOCdevkit/VOC2007/JPEGImages/'+filename+'.jpg'
        portion = os.path.split(image_path)
        # file.write(portion[1]+' detect_result：\n')
        file.write(image_path + ' ')
        image = Image.open(image_path)
        image_mAP_save_path = 'mycode/test2/mAP/input/images-optional/'
        image.save(image_mAP_save_path + filename + '.jpg')
        r_image = yolo.detect_image(image)
        file.write('\n')
        #r_image.show() 显示检测结果
        image_save_path = 'mycode/test2/result/result_'+portion[1]
